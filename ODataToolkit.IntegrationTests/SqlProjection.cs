namespace ODataToolkit.IntegrationTests.Sql
{
  ...
  public class When_selecting_a_single_string_property : SqlProjection
  {
    private Because of =
        () =>
        result = testDb.ConcreteCollection.ExecuteOData("?$select=Name").ToDictionaries().ToList();
  ...
  public class When_selecting_a_single_int_property : SqlProjection
  {
    private Because of =
        () =>
        result = testDb.ConcreteCollection.ExecuteOData("?$select=Age").ToDictionaries().ToList();
  ...
  public class When_selecting_a_single_datetime_property : SqlProjection
  {
    private Because of =
        () =>
        result = testDb.ConcreteCollection.ExecuteOData("?$select=Date").ToDictionaries().ToList();
  ...
  public class When_selecting_a_single_boolean_property : SqlProjection
  {
    private Because of =
        () =>
        result = testDb.ConcreteCollection.ExecuteOData("?$select=Complete").ToDictionaries().ToList();
  ...
  public class When_selecting_multiple_properties : SqlProjection
  {
    private Because of =
        () =>
        result = testDb.ConcreteCollection.ExecuteOData("?$select=Name,Age").ToDictionaries().ToList();
  ...
  public class When_selecting_a_nullable_int_property : SqlProjection
  {
    private Because of =
        () =>
        result = testDb.NullableCollection.ExecuteOData("?$select=Age").ToDictionaries().ToList();
