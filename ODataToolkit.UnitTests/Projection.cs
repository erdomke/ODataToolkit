namespace ODataToolkit.UnitTests
{
  ...
  public abstract class Projection
  {
    ...
    protected static IEnumerable<Dictionary<string, object>> result;

    protected static IEnumerable<Dictionary<string, object>> complexResult;

    protected static IEnumerable<Dictionary<string, object>> nullableResult;
  ...
  public class When_selecting_a_single_string_property : Projection
  {
    private Because of =
        () =>
        result = concreteCollection.AsQueryable().ExecuteOData("?$select=Name").ToDictionaries();
  ...
  public class When_selecting_a_single_int_property : Projection
  {
    private Because of =
        () =>
        result = concreteCollection.AsQueryable().ExecuteOData("?$select=Age").ToDictionaries();
  ...
  public class When_selecting_a_single_datetime_property : Projection
  {
    private Because of =
        () =>
        result = concreteCollection.AsQueryable().ExecuteOData("?$select=Date").ToDictionaries();
  ...
  public class When_selecting_a_single_boolean_property : Projection
  {
    private Because of =
        () =>
        result = concreteCollection.AsQueryable().ExecuteOData("?$select=Complete").ToDictionaries();
  ...
  public class When_selecting_multiple_properties : Projection
  {
    private Because of =
        () =>
        result = concreteCollection.AsQueryable().ExecuteOData("?$select=Name,Age").ToDictionaries();
  ...
  public class When_selecting_a_nullable_int_property : Projection
  {
    private Because of =
        () =>
        nullableResult = nullableCollection.AsQueryable().ExecuteOData("?$select=Age").ToDictionaries();
  ...
  public class When_selecting_a_single_string_property_then_ordering_it : Projection
  {
    private Because of =
        () =>
        result = concreteCollection.AsQueryable().ExecuteOData("?$select=Name,Age&$orderby=Name").ToDictionaries();
