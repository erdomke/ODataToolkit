namespace ODataToolkit.UnitTests
{
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData("?$filter=startswith(Name,'Sat')");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData("?$filter=endswith(Name,'day')");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData("?$filter=substringof('urn',Name)");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData("?$filter=(substringof('Mond',Name)) or (substringof('Tues',Name))");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData(@"?$filter=substringof('sat',tolower(Name))");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData(@"?$filter=substringof('SAT',toupper(Name))");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData(@"?$filter=year(Date) eq 2005");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData(@"?$filter=month(Date) eq 6");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData(@"?$filter=day(Date) eq 2");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData(@"?$filter=hour(Date) eq 10");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData(@"?$filter=minute(Date) eq 20");
  ...
  {
    private Because of =
        () => result = concreteCollection.AsQueryable().ExecuteOData(@"?$filter=second(Date) eq 50");
