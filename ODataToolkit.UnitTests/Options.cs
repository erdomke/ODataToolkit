namespace ODataToolkit.UnitTests
{
  ...
  {
    private Because of = () => result = collection.AsQueryable().ExecuteOData("$filter=not (Age eq 25)", new ExecutionSettings().WithDictionaryAccessor());
  ...
  {
    private Because of = () => result = collection.AsQueryable().ExecuteOData("$filter=Age ge 25", new ExecutionSettings().WithDictionaryAccessor());
  ...
  {
    private Because of = () => result = collection.AsQueryable().ExecuteOData("$filter=Age gt 25", new ExecutionSettings().WithDictionaryAccessor());
  ...
  {
    private Because of = () => result = collection.AsQueryable().ExecuteOData("$filter=Age le 25", new ExecutionSettings().WithDictionaryAccessor());
  ...
  {
    private Because of = () => result = collection.AsQueryable().ExecuteOData("$filter=Age lt 25", new ExecutionSettings().WithDictionaryAccessor());
  ...
  {
    private Because of = () => result = collection.AsQueryable().ExecuteOData("$filter=Age eq 25", new ExecutionSettings().WithDictionaryAccessor());
  ...
  {
    private Because of = () => result = collection.AsQueryable().ExecuteOData("$orderby=Age", new ExecutionSettings().WithDictionaryAccessor());
  ...
  {
    private Because of = () => result = collection.AsQueryable().ExecuteOData("$filter=IsValid", new ExecutionSettings().WithDictionaryAccessor());
  ...
  {
    private Because of = () => result = collection.AsQueryable().ExecuteOData("$filter=not IsValid", new ExecutionSettings().WithDictionaryAccessor());
  ...
  {
    private Because of = () => result = concreteCollection.AsQueryable().ExecuteOData("?$top=3", new ExecutionSettings().WithMaxPageSize(5), ODataVersion.All);
  ...
  {
    private Because of = () => result = concreteCollection.AsQueryable().ExecuteOData("?$top=3", new ExecutionSettings().WithMaxPageSize(1), ODataVersion.All);
  ...
  {
    private Because of = () => result = concreteCollection.AsQueryable().ExecuteOData("", new ExecutionSettings().WithMaxPageSize(1), ODataVersion.All);
