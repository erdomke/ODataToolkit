...
{
  internal class SwaggerResponse : ODataResponse
  {
    ...
    public override void WriteJson(TextWriter writer)
    {
      ...
      {
        SwaggerExtensions.GetSwaggerDoc(_uri, _model, _version).ToJson(json);
      }
    }
  }

  /// <summary>
  /// Adapted from https://github.com/OData/lab/blob/master/odata2swagger/Program.cs
  /// </summary>
  internal static class SwaggerExtensions
  {
    static JObject Responses(this JObject jObject, JObject responses)
    {
    ...
    static JObject ResponseRef(this JObject responses, string name, string description, string refType)
    {
    ...
    static JObject Response(this JObject responses, string name, string description, IEdmType type)
    {
    ...
    static JObject ResponseArrayRef(this JObject responses, string name, string description, string refType)
    {
      responses.Add(name, new JObject()
      {
        {"description", description},
    ...
    static JObject DefaultErrorResponse(this JObject responses)
    {
      return responses.ResponseRef("default", "Unexpected error", "#/definitions/_Error");
    }

    static JObject Response(this JObject responses, string name, string description)
    {
      responses.Add(name, new JObject()
      {
        {"description", description},
    ...
    static JObject Parameters(this JObject jObject, JArray parameters)
    {
      jObject.Add("parameters", parameters);
      return jObject;
    }

    static JArray Parameter(this JArray parameters, string name, string kind, string description, string type, string format = null)
    {
    ...
    static JArray Parameter(this JArray parameters, string name, string kind, string description, IEdmType type)
    {
    ...
    static JArray ParameterRef(this JArray parameters, string name, string kind, string description, string refType)
    {
      parameters.Add(new JObject()
      {
        {"name", name},
    ...
    static JObject Tags(this JObject jObject, params string[] tags)
    {
    ...
    static JObject Summary(this JObject jObject, string summary)
    {
    ...
    static JObject Description(this JObject jObject, string description)
    {
    ...
    static void SetSwaggerType(JObject jObject, IEdmType edmType)
    {
  ...
  internal class JObject : Dictionary<string, object>
  {
    public JObject DeepClone()
    {
      ...
      foreach (var kvp in this)
      {
        ...
        if (obj != null)
          result.Add(kvp.Key, obj.DeepClone());
        else if (arr != null)
          result.Add(kvp.Key, arr.DeepClone());
        else
    ...
    public void ToJson(JsonTextWriter json)
    {
  ...
  internal class JArray : List<object>
  {
    public JArray() : base() { }
    public JArray(IEnumerable<object> collection) : base(collection) { }
    public JArray(params object[] collection) : base(collection) { }
    private JArray(int capacity) : base(capacity) { }

    public JArray DeepClone()
    {
      var result = new JArray(this.Count);
