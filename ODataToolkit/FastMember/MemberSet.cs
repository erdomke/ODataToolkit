...
namespace ODataToolkit.FastMember
{
  ...
  /// </summary>
  public sealed class Member : MemberInfo
  {
    private readonly MemberInfo member;
    internal Member(MemberInfo member) : base()
    {
      this.member = member;
    }
    /// <summary>
    ...
    public override MemberTypes MemberType { get { return member.MemberType; } }
    public override Type DeclaringType { get { return member.DeclaringType; } }
    public override Type ReflectedType { get { return member.ReflectedType; } }
  }
}
