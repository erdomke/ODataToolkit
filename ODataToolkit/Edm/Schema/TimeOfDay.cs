...
namespace ODataToolkit
{
  ...
  public struct TimeOfDay : IComparable, IComparable<TimeOfDay>, IEquatable<TimeOfDay>
  {
    ...
    /// <summary>
    /// Min value of <see cref="ODataToolkit.TimeOfDay"/>
    /// </summary>
    public static readonly TimeOfDay MinValue = new TimeOfDay(MinTickValue);

    /// <summary>
    /// Max value of <see cref="ODataToolkit.TimeOfDay"/>
    /// </summary>
    ...
    /// <summary>
    /// Consturctor of <see cref="ODataToolkit.TimeOfDay"/>
    /// </summary>
    ...
    /// <summary>
    /// Gets a <see cref="ODataToolkit.TimeOfDay"/> object that is set to current time on this computer, expressed as the local time.
    /// </summary>
    ...
    /// <summary>
    /// Indicates whether two <see cref="ODataToolkit.TimeOfDay"/> instances are not equal.
    /// </summary>
    ...
    /// <summary>
    /// Indicates whether two <see cref="ODataToolkit.TimeOfDay"/> instances are equal.
    /// </summary>
    /// <param name="firstOperand">The first time interval to compare.</param>
    /// <param name="secondOperand">The second time interval to compare.</param>
    ...
    /// <summary>
    /// Indicates whether a specified <see cref="ODataToolkit.TimeOfDay"/> is greater equal to
    /// another specified <see cref="ODataToolkit.TimeOfDay"/>.
    /// </summary>
    /// <param name="firstOperand">The first time interval to compare.</param>
    /// <param name="secondOperand">The second time interval to compare.</param>
    ...
    /// <summary>
    /// Indicates whether a specified <see cref="ODataToolkit.TimeOfDay"/> is greater than
    /// another specified <see cref="ODataToolkit.TimeOfDay"/>.
    /// </summary>
    /// <param name="firstOperand">The first time interval to compare.</param>
    /// <param name="secondOperand">The second time interval to compare.</param>
    ...
    /// <summary>
    /// Indicates whether a specified <see cref="ODataToolkit.TimeOfDay"/> is less equal to
    /// another specified <see cref="ODataToolkit.TimeOfDay"/>.
    /// </summary>
    /// <param name="firstOperand">The first time interval to compare.</param>
    /// <param name="secondOperand">The second time interval to compare.</param>
    ...
    /// <summary>
    /// Indicates whether a specified <see cref="ODataToolkit.TimeOfDay"/> is less than
    /// another specified <see cref="ODataToolkit.TimeOfDay"/>.
    /// </summary>
    /// <param name="firstOperand">The first time interval to compare.</param>
    /// <param name="secondOperand">The second time interval to compare.</param>
    ...
    /// and returns an bool that indicates whether the specified object is <see cref="ODataToolkit.TimeOfDay"/>
    /// and this instance is same as the specified <see cref="ODataToolkit.TimeOfDay"/> value.
    /// </summary>
    ...
    /// <summary>
    /// Converts a specified string representation of a date to <see cref="ODataToolkit.TimeOfDay"/> with CurrentCulture format.
    /// </summary>
    /// <param name="text">A string that represent a timeofday to convert.</param>
    /// <returns>The <see cref="ODataToolkit.TimeOfDay"/> instance represented by text</returns>
    ...
    /// <summary>
    /// Converts a specified string representation of a date to <see cref="ODataToolkit.TimeOfDay"/>.
    /// </summary>
    /// <param name="text">A string that represent a timeofday to convert.</param>
    ...
    /// <summary>
    /// Try converts a specified string representation of a timeofday to <see cref="ODataToolkit.TimeOfDay"/> with CurrentCulture.
    /// </summary>
    /// <param name="text">A string that represent a timeofday to convert.</param>
    /// <param name="result">A <see cref="ODataToolkit.TimeOfDay"/> object equivalent to the date input, if the conversion succeeded
    /// or <see cref="ODataToolkit.TimeOfDay.MinValue"/>, if the conversion failed.</param>
    ...
    /// <summary>
    /// Try converts a specified string representation of a timeofday to <see cref="ODataToolkit.TimeOfDay"/>.
    /// </summary>
    /// <param name="text">A string that represent a timeofday to convert.</param>
    /// <param name="provider">>An object that supplies culture-specific formatting information about text.</param>
    /// <param name="result">A <see cref="ODataToolkit.TimeOfDay"/> object equivalent to the date input, if the conversion succeeded
