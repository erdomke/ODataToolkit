...
namespace ODataToolkit
{
    ...
    {
        /// <summary>
        /// Min value of <see cref="ODataToolkit.Date"/>
        /// </summary>
        public static readonly Date MinValue = new Date(1, 1, 1);

        /// <summary>
        /// Max value of <see cref="ODataToolkit.Date"/>
        /// </summary>
        ...
        /// <summary>
        /// Consturctor of <see cref="ODataToolkit.Date"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets a <see cref="ODataToolkit.Date"/> object that is set to current date on this computer, expressed as the local time.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether two specified instances of <see cref="ODataToolkit.Date"/> are equal.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether two specified instances of <see cref="ODataToolkit.Date"/> are not equal.
        /// </summary>
        /// <param name="firstOperand">The first object to compare.</param>
        /// <param name="secondOperand">The second object to compare.</param>
        ...
        /// <summary>
        /// Determines whether one specified <see cref="ODataToolkit.Date"/> is less than
        /// another specified <see cref="ODataToolkit.Date"/>
        /// </summary>
        /// <param name="firstOperand">The first object to compare.</param>
        /// <param name="secondOperand">The second object to compare.</param>
        ...
        /// <summary>
        /// Determines whether one specified <see cref="ODataToolkit.Date"/> is less equal to
        /// another specified <see cref="ODataToolkit.Date"/>
        /// </summary>
        /// <param name="firstOperand">The first object to compare.</param>
        /// <param name="secondOperand">The second object to compare.</param>
        ...
        /// <summary>
        /// Determines whether one specified <see cref="ODataToolkit.Date"/> is greater than
        /// another specified <see cref="ODataToolkit.Date"/>
        /// </summary>
        /// <param name="firstOperand">The first object to compare.</param>
        /// <param name="secondOperand">The second object to compare.</param>
        ...
        /// <summary>
        /// Determines whether one specified <see cref="ODataToolkit.Date"/> is greater equal to
        /// another specified <see cref="ODataToolkit.Date"/>
        /// </summary>
        /// <param name="firstOperand">The first object to compare.</param>
        /// <param name="secondOperand">The second object to compare.</param>
        ...
        /// and returns an bool that indicates whether the specified object is <see cref="ODataToolkit.Date"/>
        /// and this instance is same as the specified <see cref="ODataToolkit.Date"/> value.
        /// </summary>
        /// <param name="obj">The object to compare to the current instance</param>
        /// <returns>True for equal, false for non-equal.</returns>
        ...
        /// <summary>
        /// Converts a specified string representation of a date to <see cref="ODataToolkit.Date"/> with CurrentCulture format.
        /// </summary>
        /// <param name="text">A string that represent a date to convert.</param>
        /// <returns>The <see cref="ODataToolkit.Date"/> instance represented by text </returns>
        ...
        /// <summary>
        /// Converts a specified string representation of a date to <see cref="ODataToolkit.Date"/>.
        /// </summary>
        /// <param name="text">A string that represent a date to convert.</param>
        ...
        /// <summary>
        /// Try converts a specified string representation of a date to <see cref="ODataToolkit.Date"/> with CurrentCulture format.
        /// </summary>
        /// <param name="text">A string that represent a date to convert.</param>
        /// <param name="result">A <see cref="ODataToolkit.Date"/> object equivalent to the date input, if the conversion succeeded
        /// or <see cref="ODataToolkit.Date.MinValue"/>, if the conversion failed.</param>
        ...
        /// <summary>
        /// Try converts a specified string representation of a date to <see cref="ODataToolkit.Date"/>
        /// </summary>
        /// <param name="text">A string that represent a date to convert.</param>
        /// <param name="provider">An object that supplies culture-specific formatting information about text.</param>
        /// <param name="result">A <see cref="ODataToolkit.Date"/> object equivalent to the date input, if the conversion succeeded
