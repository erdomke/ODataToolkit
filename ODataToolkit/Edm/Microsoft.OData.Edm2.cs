...
namespace ODataToolkit {
    ...
    internal sealed class EntityRes {
        ...
        internal EntityRes() {
#if !PORTABLELIB
            resources = new System.Resources.ResourceManager("ODataToolkit", this.GetType().Assembly);
#else
            resources = new System.Resources.ResourceManager("ODataToolkit", this.GetType().GetTypeInfo().Assembly);
#endif
        }
