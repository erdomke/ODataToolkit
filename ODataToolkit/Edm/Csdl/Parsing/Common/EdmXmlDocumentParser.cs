...
namespace ODataToolkit.Csdl.Parsing.Common
{
    internal abstract class EdmXmlDocumentParser<TResult> : XmlDocumentParser<TResult>
    {
        ...
        internal XmlAttributeInfo GetRequiredAttribute(XmlElementInfo element, string attributeName)
        {
            ...
            if (attr.IsMissing)
            {
                this.ReportError(element.Location, EdmErrorCode.MissingAttribute, Strings.XmlParser_MissingAttribute(attributeName, element.Name));
                return attr;
            }
        ...
        protected int? OptionalInteger(string attributeName)
        {
            ...
            if (!attr.IsMissing)
            {
                ...
                {
                    this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidInteger, Strings.ValueParser_InvalidInteger(attr.Value));
                }
        ...
        protected long? OptionalLong(string attributeName)
        {
            ...
            if (!attr.IsMissing)
            {
                ...
                {
                    this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidLong, Strings.ValueParser_InvalidLong(attr.Value));
                }
        ...
        protected int? OptionalScale(string attributeName)
        {
            ...
            if (!attr.IsMissing)
            {
                ...
                else
                {
                    ...
                    {
                        this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidSrid, Strings.ValueParser_InvalidScale(attr.Value));
                    }
                }
        ...
        protected int? OptionalMaxLength(string attributeName)
        {
            ...
            if (!attr.IsMissing)
            {
                ...
                if (!EdmValueParser.TryParseInt(attr.Value, out value))
                {
                    this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidMaxLength, Strings.ValueParser_InvalidMaxLength(attr.Value));
                }
        ...
        protected EdmMultiplicity RequiredMultiplicity(string attributeName)
        {
            ...
            if (!attr.IsMissing)
            {
                switch (attr.Value)
                {
                    ...
                    default:
                        this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidMultiplicity, Strings.CsdlParser_InvalidMultiplicity(attr.Value));
                        break;
                }
            }
        ...
        protected EdmOnDeleteAction RequiredOnDeleteAction(string attributeName)
        {
            ...
            if (!attr.IsMissing)
            {
                switch (attr.Value)
                {
                    ...
                    default:
                        this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidOnDelete, Strings.CsdlParser_InvalidDeleteAction(attr.Value));
                        break;
                }
            }
        ...
        protected bool? OptionalBoolean(string attributeName)
        {
            ...
            if (!attr.IsMissing)
            {
                ...
                {
                    this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidBoolean, Strings.ValueParser_InvalidBoolean(attr.Value));
                }
        ...
        protected string ValidateEnumMembersPath(string path)
        {
            ...
            {
                this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidEnumMemberPath, Strings.CsdlParser_InvalidEnumMemberPath(path));
            }
        ...
        private string ValidateTypeName(string name)
        {
            ...
            switch (typeName)
            {
                ...
                case CsdlConstants.Value_Ref:
                    ...
                    if (typeInformation.Count() == 1)
                    {
                        this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidTypeName, Strings.CsdlParser_InvalidTypeName(name));
                        return name;
                    }
                    else
                    {
            ...
            if (EdmUtil.IsQualifiedName(typeName) || ODataToolkit.EdmCoreModel.Instance.GetPrimitiveTypeKind(typeName) != EdmPrimitiveTypeKind.None)
            {
                return name;
            }
            else
        ...
        private string ValidateAlias(string name)
        {
            ...
            {
                this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidQualifiedName, Strings.CsdlParser_InvalidAlias(name));
            }
        ...
        private string ValidateEntitySetPath(string path)
        {
            ...
            if (!(segments.Count() == 2 &&
                ...
                EdmUtil.IsValidUndottedName(segments[1])))
            {
                this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidEntitySetPath, Strings.CsdlParser_InvalidEntitySetPath(path));
            }
        ...
        private string ValidateQualifiedName(string qualifiedName)
        {
            ...
            {
                this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidQualifiedName, Strings.CsdlParser_InvalidQualifiedName(qualifiedName));
            }
