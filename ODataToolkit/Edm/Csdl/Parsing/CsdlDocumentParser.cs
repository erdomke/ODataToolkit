...
using ODataToolkit.Csdl.Parsing.Common;
using ODataToolkit.Validation;
using ODataToolkit.Vocabularies;

namespace ODataToolkit.Csdl.Parsing
{
    /// <summary>
    ...
    internal class CsdlDocumentParser : EdmXmlDocumentParser<CsdlSchema>
    {
        ...
        private void ReportOperationReadErrorsIfExist(string entitySetPath, bool isBound, string name)
        {
            ...
            {
                this.ReportError(this.currentElement.Location, EdmErrorCode.InvalidEntitySetPath, Strings.CsdlParser_InvalidEntitySetPathWithUnboundAction(CsdlConstants.Element_Action, name));
            }
        }
