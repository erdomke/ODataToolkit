...
using ODataToolkit.Csdl.Parsing;
    ...
    public class CsdlReader
    {
        ...
        private bool TryParseCsdlFileToCsdlModel(out Version csdlVersion, out CsdlModel csdlModel)
        {
            ...
            try
            {
                ...
                {
                    this.RaiseError(EdmErrorCode.UnexpectedXmlElement, Strings.XmlParser_UnexpectedRootElement(this.reader.Name, CsdlConstants.Element_Edmx));
                    return false;
                }
        ...
        private void ParseTargetElement(string elementName, Dictionary<string, Action> elementParsers)
        {
            ...
            else
            {
                ...
                this.RaiseError(EdmErrorCode.UnexpectedXmlElement, Strings.EdmxParser_BodyElement(CsdlConstants.Element_DataServices));
