...
#endif
{
    ...
    internal static class EdmValueWriter
    {
        ...
        /// </summary>
        /// <param name="d">The <see cref="ODataToolkit.Date"/> to be converted</param>
        /// <returns>A System.String representation of the supplied <see cref="ODataToolkit.Date"/>.</returns>
