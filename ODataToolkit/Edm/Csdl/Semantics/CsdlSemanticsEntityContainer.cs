    ...
    internal class CsdlSemanticsEntityContainer : CsdlSemanticsElement, IEdmEntityContainer, IEdmCheckable
    {
        ...
        private void AddOperationImport(CsdlOperationImport operationImport, List<IEdmEntityContainerElement> elements)
        {
            ...
            if (operationsCount == 0)
            {
                ...
                {
                    var action = new UnresolvedAction(operationImport.SchemaOperationQualifiedTypeName, Strings.Bad_UnresolvedOperation(operationImport.SchemaOperationQualifiedTypeName), operationImport.Location);
                ...
                else
                {
                    ...
                    var function = new UnresolvedFunction(operationImport.SchemaOperationQualifiedTypeName, Strings.Bad_UnresolvedOperation(operationImport.SchemaOperationQualifiedTypeName), operationImport.Location);
