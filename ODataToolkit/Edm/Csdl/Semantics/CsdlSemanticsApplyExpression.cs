...
namespace ODataToolkit.Csdl.CsdlSemantics
{
    internal class CsdlSemanticsApplyExpression : CsdlSemanticsExpression, IEdmApplyExpression, IEdmCheckable
    {
        ...
        private IEdmFunction ComputeAppliedFunction()
        {
            ...
            if (candidateCount == 0)
            {
                return new UnresolvedFunction(this.expression.Function, Strings.Bad_UnresolvedOperation(this.expression.Function), this.Location);
            }
            ...
            if (candidateCount > 1)
            {
                ...
                if (candidateCount != 1)
                {
                    return new UnresolvedFunction(this.expression.Function, Strings.Bad_AmbiguousOperation(this.expression.Function), this.Location);
                }
            ...
            if (candidateCount == 0)
            {
                return new UnresolvedFunction(this.expression.Function, Strings.Bad_OperationParametersDontMatch(this.expression.Function), this.Location);
            }
